    ...
    <div class="article-banner">
        ...
        <div class="banner-info">
            <div class="banner-left">
                ...
                <p class="pic">
                    <#if model.courseBase.charge=='201001'>
                            ...
                            <div class="item">
                                ...
                                <div class="drop-down" style="height: 260px;">
                                    <ul class="list-box">
                                        ...
                                        <li class="active"><a href="http://www.51xuecheng.cn/course/preview/learning.html?id=${model.courseBase.id}&chapter=${secondNode.teachplanMedia.teachplanId!''}" target=_blank>${secondNode.pname}</a></li>
                                        </#list>
                                    </ul>
                                </div>
                            </div>
